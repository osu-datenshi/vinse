<template>
  <div>
    <hero title="Datenshi" subtitle="A directory of multiplayer games on Datenshi" class="is-info"></hero>
    <section class="section">
      <div class="container box content">
        <p>
          Welcome to Datenshi. Datenshi is a website from which you can see all the
          multiplayer matches that are happening right now on Datenshi. On this
